/**
 * Vietnamese-aware search utilities (frontend).
 * Mirrors the backend logic so client-side filtering is also accent/space-insensitive.
 */
...
/**
 * Generate a search key: strip diacritics, lowercase, remove all whitespace.
...
/**
 * Check whether `text` contains `query` in an accent/space-insensitive manner.
 */
